...
public class ApiGithub {
    ...
    private ApiGithubLicense license;
    @JsonProperty("forks")
    ...
    @JsonProperty("owner")
    public ApiGithubOwner getOwner() {
        return owner;
    }

    @JsonProperty("owner")
    public void setOwner(ApiGithubOwner owner) {
        this.owner = owner;
    }
    ...
    @JsonProperty("license")
    public ApiGithubLicense getLicense() {
        return license;
    }

    @JsonProperty("license")
    public void setLicense(ApiGithubLicense license) {
        this.license = license;
    }
    ...
    public String toString() {
        ...
        sb.append(ApiGithub.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
